...
class ReviewsTest < ApplicationSystemTestCase
  ...
  test "creating a Review" do
    ...
    fill_in "Personalscore", with: @review.personalscore
    fill_in "Projectno", with: @review.projectno
    fill_in "Studentid", with: @review.studentid
    fill_in "Workscore", with: @review.workscore
